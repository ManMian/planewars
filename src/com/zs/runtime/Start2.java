...
/*没用到*/
public class Start2 extends BaseSprite implements Drawable, Moveable {
    private Image image;

    public Start2() {

        this(0,FRAME_HEIGHT - ImageMap.get("start1").getHeight(null), ImageMap.get("start2"));
    }

    public Start2(int x, int y, Image image) {
        super(x, y);
        this.image = image;
    }
